<template>
  <div class="h-full grid grid-cols-5">
    ...
    <div
      class="col-span-3 rounded-xl border flex flex-col justify-between p-5 bg-[#ffffff60] m-10"
    >
      ...
      <div
        @click="start"
        class="flex justify-center cursor-pointer transition-all duration-300 hover:scale-110"
      >
        <img
