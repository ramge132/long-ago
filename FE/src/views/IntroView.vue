<template>
  <div class="h-full grid grid-cols-2 relative">
    ...
    <div class="sr-only seo-content">
      <h1>롱어고 - Long Ago | AI 협동 스토리텔링 웹게임</h1>
      <p>롱어고는 AI가 그려주는 실시간 협동 스토리텔링 게임입니다. 친구들과 함께 창의적인 이야기를 만들고 AI가 실시간으로 삽화를 그려줍니다.</p>
      ...
      <h2>인기 검색어</h2>
      <p>롱어고, 아주 먼 옛날, long ago, 옛날 옛적에, AI게임, 웹게임, 멀티게임, 그리기 게임, 책 게임, 스토리텔링 게임, 실시간 게임, 협동 게임, 온라인 게임, AI 그림, 창작 게임, 무료 게임, 브라우저 게임, 친구와 게임, 동화 만들기, 이야기 게임, 멀티플레이어 게임, AI 이미지 생성</p>
      ...
      <h2>자주 묻는 질문</h2>
      <h3>롱어고은 무료인가요?</h3>
      <p>네, 롱어고는 완전 무료 게임입니다. 회원가입 없이도 바로 플레이할 수 있습니다.</p>
