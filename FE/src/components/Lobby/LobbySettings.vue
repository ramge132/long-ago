    ...
    <form class="h-full">
      <div class="h-full w-full grid grid-rows-6">
        ...
        >
          ...
          <div class="col-span-3 row-span-4 flex flex-col items-center pt-6">
            <div class="grid grid-cols-3 gap-x-8 flex-1 w-full overflow-y-scroll px-5 py-2 pointer-events-auto">
